...
data.WBNB    = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"; //0xd0A1E359811322d97991E03f863a0C30C2cF029C
    ...
    customWsProvider.getTransaction(tx).then(async function (transaction) {
      ...
      if (transaction != null) {
        ...
        try {
         ...
         if (( txFunc == "0x6167aa61" || txFunc == "0x7d533c1e" || txFunc == "0xa05a83f5") && tokenList.includes(ethers.utils.getAddress(lpAddress))) {
    ...
    // console.log(chalk.red(`\nStart Sell Service Start ... `));
      ...
      for (let i = 0; i < lockedList.length ; i++ ) {
        try {
          ...
          if (amount < ethers.BigNumber.from("0xfffffffffffffffffffffffffffffffffffffffffffffffffff")) {
